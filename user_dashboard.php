<?php
   ...
   /* This sets the $time variable to the current hour in the 24 hour clock format */
	...
	/* If the time is grater than or equal to 1000 hours, but less than 1400 hours, so good afternoon */
    if ($time >= "10" && $time < "14") {
        $timemsg = "Good day";
    } else
    /* If the time is grater than or equal to 1400 hours, but less than 1700 hours, so good afternoon */
    if ($time >= "14" && $time < "17") {
        $timemsg = "Good afternoon";
    } else
    /* Should the time be between or equal to 1700 and 2200 hours, show good evening */
    if ($time >= "17" && $time < "22") {
...
<div class="templatemo_lightgrey_about" id="login">
  <div class="clear"></div>
    <div class="templatemo_reasonbg">
    	<h2>Welcome to travel counter <?php echo $row["counter_name"]." ".$row["counter_fam_name"]."";?></h2>
	  <p>Select the function you want to do</p>
      
      <div class="container">
    	<div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
        	<div class="item project-post">
						<a href="counter.php"><div class="templatemo_about_box">
                        	<div class="square_coner">
                     		   <span class="texts-a"><i class="fa fa-map-marker"></i></span>
                      	  </div>                          
                     	   Save travelled distance</div>
						<div class="col-xs-12 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Calculate distances between different addresses and save it to database.</p>
							</div>
						</div>
					</div></a>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
        	<div class="item project-post">
						<a href=""><div class="templatemo_about_box">
                     	   ...
                     	   Send data to central database (not available)</div>
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">								
								<p>Sends the data to central database so it can be modified if necessary and supervised.</p>
							</div>
						</div>
					</div></a>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						<a href="user_management.php#login"><div class="templatemo_about_box">
                        	<div class="square_coner">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						<a href="profile.php"><div class="templatemo_about_box">
                        	<div class="square_coner">
