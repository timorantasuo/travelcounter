...
elseif (strlen( $_POST['counter_password']) > 86 || strlen($_POST['counter_password']) < 4)
{
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT counter_email, counter_password FROM counter_users WHERE counter_email = '$email'";
          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a class="menu" href="admin_login.php">Admin</a></li>
              </ul>
            </nav>
            </div>
          </div>
...
<div class="templatemo_lightgrey_about" id="login">
  <div class="clear"></div>
    <div class="templatemo_reasonbg">
      ...
      <p>Not registered yet? <a href="register.php"><b>Register here!</b></a></p>
