<?php
   include('session.php');
     $result = mysqli_query($db,"SELECT * FROM counter_travel");
?>
          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a class="menu" href="#home">Travels</a></li>
                <li><a class="menu" href="admin_dashboard.php">Start screen</a></li>
      	...
      	<div  id="slider"  class="nivoSlider templatemo_slider">
            ...
            <img src="images/slider/img_3_blank.jpg" alt="slide 3" />	        	
             ...
             <div class="templatemo_caption">
                    ...
                    <div class="clear"></div>
                    <h1>Management of saved travel data</h1>
                    <div class="clear"></div>
               <p class="col-xs-12 col-sm-5 col-md-10">See travel data below</p><br>
	          	    <a class="btn btn-large btn-primary" href="#save">Go down</a>
       		   
       	       
    </div>  
  </header>
  <div class="clear"></div>
  <div class="templatemo_blog" id="save">
    	<h2>Travel Counter: Saved data</h2>
        <div class="clear"></div>
        <div class="container">
		<?php
		...
		echo "<b>ID: </b>" . $see['counter_id']. " | <b>Startingpoint:</b> " . $see['startingpoint']. " | <b>Destination:</b> " . $see['destination']. " | <b>Distance:</b> " . $see['distance']. "<br><hr>"; }mysqli_close($db);?>
        </div>
</div>
<div class="clear"></div>
