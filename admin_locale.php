	 ...
	 if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      // If result matched $email , table row must be 1 row
		...
		$retval = mysqli_query($db,$statement);
			...
			$message = "Updated addresses successfully.<br><strong>Address: </strong>".$address."<br><strong>Postcode:</strong> ".$postcode."<br><strong>City: </strong>".$city.'</strong><br><a href="admin_management.php"><b>Go back to settings here.</b></a>';
