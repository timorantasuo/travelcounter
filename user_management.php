          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a class="menu" href="user_dashboard.php#login">Start screen</a></li>
      ...
      <div class="container">
    	<div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
        	<div class="item project-post">
						<a href="user_dashboard.php#login"><div class="templatemo_about_box">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
        	<div class="item project-post">
						<a href="user_password.php"><div class="templatemo_about_box">
                        	<div class="square_coner">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						<a href="user_email.php"><div class="templatemo_about_box">
                        	<div class="square_coner">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						<a href="user_locale.php"><div class="templatemo_about_box">
                        	<div class="square_coner">
