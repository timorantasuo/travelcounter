...
ddsmoothmenu.init({
          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a class="menu" href="#home">Profile</a></li>
  ...
  <div class="templatemo_blog" id="profile">
      ...
      <strong>Your email: </strong><?php echo $row["counter_email"]."";?><a href="admin_email.php"><strong> Change</strong></a><hr>
      <strong>Your address: </strong><?php echo $row["counter_address"]."";?><a href="admin_locale.php"> <strong> Change</strong></a><hr>
      <strong>Your postal code and city: </strong><?php echo $row["counter_postcode"]." ".$row["counter_city"]."";?><a href="admin_locale.php"> <strong> Change</strong></a><hr>
